...
public struct AWSDynamoDBClientGenerator {
    ...
    public func with<NewTraceContextType: InvocationTraceContext>(
            ...
            eventLoop: EventLoop? = nil) -> AWSDynamoDBClient<StandardHTTPClientCoreInvocationReporting<NewTraceContextType>> {
    ...
    public func with(
            logger: Logging.Logger,
            internalRequestId: String = "none",
            eventLoop: EventLoop? = nil) -> AWSDynamoDBClient<StandardHTTPClientCoreInvocationReporting<AWSClientInvocationTraceContext>> {
        let reporting = StandardHTTPClientCoreInvocationReporting(
            logger: logger,
            internalRequestId: internalRequestId,
