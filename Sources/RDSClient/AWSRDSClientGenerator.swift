...
public struct AWSRDSClientGenerator {
    ...
    public func with<NewTraceContextType: InvocationTraceContext>(
            ...
            eventLoop: EventLoop? = nil) -> AWSRDSClient<StandardHTTPClientCoreInvocationReporting<NewTraceContextType>> {
    ...
    public func with(
            logger: Logging.Logger,
            internalRequestId: String = "none",
            eventLoop: EventLoop? = nil) -> AWSRDSClient<StandardHTTPClientCoreInvocationReporting<AWSClientInvocationTraceContext>> {
        let reporting = StandardHTTPClientCoreInvocationReporting(
            logger: logger,
            internalRequestId: internalRequestId,
