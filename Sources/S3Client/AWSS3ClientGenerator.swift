...
public struct AWSS3ClientGenerator {
    ...
    public func with<NewTraceContextType: InvocationTraceContext>(
            ...
            eventLoop: EventLoop? = nil) -> AWSS3Client<StandardHTTPClientCoreInvocationReporting<NewTraceContextType>> {
    ...
    public func with(
            logger: Logging.Logger,
            internalRequestId: String = "none",
            eventLoop: EventLoop? = nil) -> AWSS3Client<StandardHTTPClientCoreInvocationReporting<AWSClientInvocationTraceContext>> {
        let reporting = StandardHTTPClientCoreInvocationReporting(
            logger: logger,
            internalRequestId: internalRequestId,
